...
3. Run docker container
    ...
    ```docker run -ti -e DISPLAY=$DISPLAY -v F:\data\root:/root apazga/docker-pgmodeler:1.0.6```

    You can also specify your DISPLAY IP directly if you don't want to define an environment variable:

    ```docker run -ti -e DISPLAY=192.168.1.100:0.0 -v F:\data\root:/root apazga/docker-pgmodeler:1.0.6```
...
Full changelog: <https://github.com/pgmodeler/pgmodeler/blob/v1.0.6/CHANGELOG.md>
